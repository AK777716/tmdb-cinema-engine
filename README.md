...
- ⚙️ **ETL & Automation Pipeline**: [Python Ingestion & GitHub Actions Workflows](./analysis/PIPELINE_ETL_AUTOMATION.md)
---
...
### 📑 [Data Pipeline, Ingestion & Automation](./analysis/PIPELINE_ETL_AUTOMATION.md):
   * Python ETL scripts (`full_pipeline.py`, `bulk_backfill.py`, `ingest_ids.py`).
   * GitHub Actions CI/CD workflows for automated daily incremental syncs.
   * Rate-limiting logic and BigQuery Bronze streaming ingestion setup.
